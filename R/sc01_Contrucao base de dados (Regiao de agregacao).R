...
#
# Script que cria banco de dados a partir dos arquivos CSV da RAIS
#
# Outputs:
#
...
# atuais. Ex: Regioes de Tocantins.
source("./Function AtualizaIdMunicipio.R")

# carrego a lista de regioes ignoradas, é necessario para filtrar os dados
# provenientes do BI da RAIS
...
for(ano in 1995:2018){
  ...
  # Atualiza os dados de municipio velho
