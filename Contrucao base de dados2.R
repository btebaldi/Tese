...
full.EmpLiqu <- full.amc %>% mutate(Liq_1995M01 = ADM_1995M01 - DES_1995M01,
                    ...
                    ) %>% select(amc, starts_with("Liq"))



readr::write_excel_csv(full.EmpLiqu, path = "./Excel Export/full_EmpLiq.csv")
